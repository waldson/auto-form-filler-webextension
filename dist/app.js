...
/* harmony import */ var _browser_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./browser-polyfill */ "./assets/js/browser-polyfill.js");
/* harmony import */ var _browser_polyfill__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_browser_polyfill__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./assets/js/store.js");



var fillForms = function fillForms() {
  window.browser.tabs.query({
    active: true,
    currentWindow: true
  }).then(function (tabs) {
    window.browser.storage.local.get('state').then(function (response) {
      if (response.state) {
        window.browser.tabs.executeScript(tabs[0].id, {
...
/* harmony import */ var vuex_webextensions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vuex-webextensions */ "./node_modules/vuex-webextensions/dist/index.js");
/* harmony import */ var vuex_webextensions__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(vuex_webextensions__WEBPACK_IMPORTED_MODULE_3__);
...
var store = {
  ...
  mutations: {
    saveRule: function saveRule(state, rule) {
      var newRule = JSON.parse(JSON.stringify(rule));
      var index = state.rules.findIndex(function (el) {
        if (el.id == newRule.id) {
          return true;
        }
      });
    ...
    updateFakerLocale: function updateFakerLocale(state, locale) {
      state.locale = locale;
    },
    ...
    updateGlobalScript: function updateGlobalScript(state, globalScript) {
...
var vuexStore = new vuex__WEBPACK_IMPORTED_MODULE_2__["default"].Store(store);
vuexStore.subscribe(function (mutation, state) {
...
/* harmony default export */ __webpack_exports__["default"] = (vuexStore);
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:!0}),exports.filterObject=filterObject;function filterObject(a,b){var c={};return b.forEach(function(b){c[b]=a[b]}),c}
...
__webpack_require__(/*! /home/waldson/www/auto-form-filler/assets/js/app.js */"./assets/js/app.js");
module.exports = __webpack_require__(/*! /home/waldson/www/auto-form-filler/assets/scss/app.scss */"./assets/scss/app.scss");
