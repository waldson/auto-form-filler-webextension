...
var fillForms = function fillForms() {
  window.browser.tabs.query({
    ...
    window.browser.tabs.executeScript(tabs[0].id, {
      code: 'var __aff_state = ' + JSON.stringify(_store__WEBPACK_IMPORTED_MODULE_0__["default"].state) + ';'
    }).then(function () {
      window.browser.tabs.executeScript(tabs[0].id, {
...
var store = {
  ...
  mutations: {
    ...
    incrementCounter: function incrementCounter(state) {
      state.count += 1;
    },
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store(_objectSpread({}, store, {
